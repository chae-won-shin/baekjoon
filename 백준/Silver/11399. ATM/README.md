...
### 출력 
 ...
 <p>
대기시간을 최소로 하여 사람들이 돈을 인출하는 데 걸리는 시간의 합을 최소로 만드는 문제 → 인출하는 데 소요되는 시간의 누적 합을 최소로 만들어야 함 → <b>오름차순 정렬</b>

오름차순 정렬: Array.sort((a,b) ⇒ a-b);

누적 합: temp에 i번째 사람의 대기시간+인출시간을 담아 놓고, time에서 temp값을 다 더했음</p>
