...
1. 배열에서 두 수를 선택하는 모든 경우의 수 -> 하나 선택 후 남은 모든 수와 한번씩 더하기(이중반복문)
2. 중복값 제거 -> Set
3. 오름차순 정렬 -> Sort((a,b) => a-b)

Sort()에 아무 파라미터도 넣어주지 않으면 default로 내림차순 정렬한다!!
